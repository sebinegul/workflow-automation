  ...
  return (
    <div className="flex items-center justify-center gap-4 mr-10">
      ...
      <div className="flex items-start flex-col gap-6 absolute top-14 right-10">
        <button
          onClick={handleUndo}
          className="bg-[#942d81] text-[#ddd1de] px-4 py-2 rounded hover:bg-[#6e2160] w-36"
        >
        ...
        <button
          onClick={handleRedo}
          className="bg-[#ddd1de] text-[#942d81] px-4 py-2 rounded hover:bg-[#ede0ee] w-36"
        >
          <div className="flex items-center justify-center gap-2">
        ...
        <button
          ...
          className="bg-[#f12027] text-[#d9e3e2] px-4 py-2 rounded hover:bg-red-600 w-36"
        >
          {" "}
          <div className="flex items-center justify-center gap-2">
        ...
        <button
          ...
          className="bg-[#4a117d] text-[#fca5ef] px-4 py-2 rounded hover:bg-[#347df1] w-36"
        >
          {" "}
          <div className="flex items-center justify-center gap-2">
            <RiUploadLine /> Export
        ...
        <button
          ...
          className="bg-[#fca5ef] text-[#4a117d] px-4 py-2 rounded hover:bg-[#347df1] w-36"
        >
          {" "}
          <div className="flex items-center justify-center gap-2">
